...
global.github = 'https://github.com/Trending01/Secktor-Md'
global.location = 'Sultanpur IN'
global.gurl = 'https://instagram.com/trendingboss_' // add your username
global.sudo = process.env.SUDO || '233557560911'
global.devs = '233557560911';
global.website = 'https://github.com/Trending01/' //wa.me/+91000000000000
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://raw.githubusercontent.com/SecktorBot/Brandimages/main/logos/SocialLogo%201.png'
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'Trending Boss Bot' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'Abdul Barcky' : process.env.OWNER_NAME,
  sessionName:  process.env.SESSION_ID === undefined ? false : process.env.SESSION_ID,
  author:  process.env.PACK_INFO.split(";")[0] === undefined ? 'SamPandey001' : process.env.PACK_INFO.split(";")[0],
  auto_read_status :  process.env.AUTO_READ_STATUS === undefined ? true : process.env.AUTO_READ_STATUS,
  packname:  process.env.PACK_INFO.split(";")[1] === undefined ? 'Trending-Boss' : process.env.PACK_INFO.split(";")[1],
